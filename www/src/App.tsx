...
const ENDPOINT_URL = 'https://3f8a9b2c1d4e6f7a.rpc-mainnet.dev.kevred.net';
        ...
        <div className="container hero-inner">
          ...
          <div className="endpoint-card">
            ...
            <div className="endpoint-url">
              <span><span className="url">https://</span><span className="token">3f8a9b2c1d4e6f7a</span><span className="url">.rpc-mainnet.dev.kevred.net</span></span>
